...
app.post('/usuario', verificarToken , verificaAdmin ,(req, res) => {
    let body = req.body;
...
app.put('/usuario/:id',verificarToken , verificaAdmin ,(req, res) => {
    let {id} = req.params;
...
app.delete('/usuario/:id',verificarToken , verificaAdmin,(req,res) => {
    let {id} = req.params;
    let body = {
        estado : false
    }
